        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-20">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2.5 glass border border-green-500/30 rounded-full px-4 py-2 mb-8 text-sm text-gray-300"
            >
            ...
            {/* Typewriter roles */}
            <div className="text-xl sm:text-2xl text-gray-300 mb-4 h-9 font-medium">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-4 -left-4 glass border border-white/10 rounded-xl px-3 py-2 text-xs font-medium"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-4 -right-4 glass border border-white/10 rounded-xl px-3 py-2 text-xs font-medium text-gray-300"
            >
              🚀 Open to work
            </motion.div>
          </motion.div>
